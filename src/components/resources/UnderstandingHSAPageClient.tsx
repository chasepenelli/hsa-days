...
interface Props {
  basics: { title: string; subtitle: string; intro: string };
...
const NAV_PILLS = [
  ...
  { label: "Where It Occurs", href: "#locations" },
  { label: "Staging", href: "#staging" },
  { label: "Diagnostics", href: "#diagnostics" },
  { label: "Treatment", href: "#treatment" },
  { label: "Breed Risks", href: "#breed-risks" },
...
export default function UnderstandingHSAPageClient({
  basics,
  keyFacts,
  tumorLocations,
  stagingInfo,
  ...
  // Expandable state for diagnostic tests
  const [openDiagnostic, setOpenDiagnostic] = useState<string | null>(null);

  // Expandable state for treatment paths
  const [openTreatment, setOpenTreatment] = useState<string | null>(null);

  // Expandable symptoms state per location
  const [openLocationSymptoms, setOpenLocationSymptoms] = useState<string | null>(null);

  // Group breed risks by level
  const highRisk = breedRisks.filter((b) => b.riskLevel === "high");
  const moderateRisk = breedRisks.filter((b) => b.riskLevel === "moderate");
  const someEvidence = breedRisks.filter((b) => b.riskLevel === "some-evidence");
  ...
  return (
    ...
    >
      ...
      >
        <div className="max-w-[800px] mx-auto">
          ...
          <h1
            ...
            style={{ fontSize: "clamp(1.75rem, 4vw, 2.5rem)", color: "var(--text)", lineHeight: 1.2 }}
          >
            {basics.title}
          </h1>
          ...
          <p
            ...
            style={{ fontSize: "var(--text-h4)", color: "var(--text-muted)", lineHeight: 1.4 }}
          >
            {basics.subtitle}
          </p>
          ...
          <p
            ...
            style={{ fontSize: "var(--text-body)", color: "var(--text)", maxWidth: 680 }}
          >
            {basics.intro}
          </p>
        </div>
      ...
      >
        <div
          className="py-3 flex gap-2 max-w-[800px] mx-auto"
      ...
      <div className="px-6">
        <div className="max-w-[800px] mx-auto">
          ...
          {/* ═══ Key Facts ═══ */}
          <section id="key-facts" className="mt-14">
            <h2
          ...
          <section id="warning" className="reveal">
            <div
            ...
            >
              ...
              <p
                ...
                style={{ fontSize: "var(--text-body)", color: "var(--text)" }}
              >
                {episodicWeaknessWarning.description}
              </p>
              ...
              <div className="mb-4">
                ...
                <ul className="space-y-1.5">
                  {episodicWeaknessWarning.signs.map((sign, i) => (
                    <li
                      key={i}
              ...
              >
                ...
                <p
                  ...
                  style={{ fontSize: "var(--text-body-sm)", color: "var(--text)" }}
                >
                  {episodicWeaknessWarning.whatToDo}
                </p>
              </div>
            </div>
          </section>
          ...
          <section id="locations">
            ...
            >
              Hemangiosarcoma most commonly forms in three primary locations, each with distinct presentation and outcomes.
            </p>

            <div className="grid gap-4 sm:grid-cols-2">
              {tumorLocations.map((loc) => {
          ...
          <section id="treatment">
            ...
            <p
              ...
              style={{ fontSize: "var(--text-body)", color: "var(--text-muted)" }}
            >
              Every family&rsquo;s situation is different. These paths reflect the current standard of care and emerging options. Discuss all choices thoroughly with a board-certified veterinary oncologist.
            </p>
          ...
          <section id="breed-risks">
            ...
            <p
              ...
              style={{ fontSize: "var(--text-body)", color: "var(--text-muted)" }}
            >
              Certain breeds appear to have genetic predispositions. Risk does not mean certainty — most individual dogs of any breed will not develop HSA.
            </p>
          ...
          <section id="research">
            ...
            <p
              ...
              style={{ fontSize: "var(--text-body)", color: "var(--text-muted)" }}
            >
              Research is advancing rapidly. These breakthroughs represent the most promising recent findings.
            </p>

            <div className="space-y-4">
              {researchBreakthroughs.map((item, i) => (
                <div
                  key={i}
          ...
          <section id="clinical-trials">
            ...
            <p
              ...
              style={{ fontSize: "var(--text-body)", color: "var(--text-muted)" }}
            >
              Clinical trials give dogs access to emerging therapies and contribute to research that helps future patients. Ask your oncologist if your dog may qualify.
            </p>
          ...
          <section id="questions">
            ...
            <p
              ...
              style={{ fontSize: "var(--text-body)", color: "var(--text-muted)" }}
            >
              Appointments move quickly. Having these written down ensures you leave with the information you need.
            </p>
            ...
            <p
              ...
              style={{ fontSize: "var(--text-body-sm)", color: "var(--text-muted)" }}
            >
              Tip: Bring a notebook or record the appointment (with permission) so you can review answers later.
            </p>
          </section>

          {/* ═══ Back to Resources ═══ */}
          <div className="mt-16 pt-8 text-center reveal" style={{ borderTop: "1px solid var(--border)" }}>
            <Link
              href="/resources"
