    ...
    >
      ...
      <div className="px-6">
        <div className="max-w-[800px] mx-auto">
          ...
          {/* ═══ Gum Color Guide ═══ */}
          <section id="gum-colors" className="mt-10">
            <h2
          ...
          {/* ═══ Emergency Scenarios ═══ */}
          <section id="emergencies" className="mt-2">
            <h2
              className="font-serif font-semibold mb-1 reveal"
              style={{
                fontSize: "clamp(1.375rem, 3vw, 1.75rem)",
          ...
          {/* ═══ Emergency Kit ═══ */}
          <section id="emergency-kit" className="mt-2">
            <h2
              className="font-serif font-semibold mb-1 reveal"
              style={{
                fontSize: "clamp(1.375rem, 3vw, 1.75rem)",
          ...
          {/* ═══ Vet Conversations ═══ */}
          <section id="vet-talks" className="mt-2">
            <h2
              className="font-serif font-semibold mb-1 reveal"
              style={{
                fontSize: "clamp(1.375rem, 3vw, 1.75rem)",
          ...
          <section id="daily-monitoring" className="mt-2">
            <h2
              className="font-serif font-semibold mb-1 reveal"
              style={{
                fontSize: "clamp(1.375rem, 3vw, 1.75rem)",
